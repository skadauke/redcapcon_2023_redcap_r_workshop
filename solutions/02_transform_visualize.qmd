...
```{r}
infusion_vitals <- redcart |> extract_tibble("infusion_vital_signs")
```
...
What do you tell your study PI? Did patients develop fevers? **No - all values seem to be in the normal range.**
