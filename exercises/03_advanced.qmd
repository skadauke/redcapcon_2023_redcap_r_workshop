...
(Two years ago I started a group to catalog them, but then I dropped the ball.)
...
[REDCap Tools](https://redcap-tools.github.io/projects/) (redcap-tools.github.io/projects/)
was created by a people to help inventory the evolving list of packages.

The most relevant to this audience include
...
* PyCap: similar goals as REDCapR --maintained by Paul Widenhaim of CHOP)
