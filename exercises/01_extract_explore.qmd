...
In this exercise, we will download REDCap data using REDCapTidier (as opposed to REDCapR) and then explore that data.
...
# Read the CAR-T cell REDCap data into an object "redcart"
